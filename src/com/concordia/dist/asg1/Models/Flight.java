...
public class Flight implements Serializable {
	...
	public String toString() {
		return "Flight [bookedFirstClassSeats=" + bookedFirstClassSeats + ", bookedBusinessClassSeats="
				+ bookedBusinessClassSeats + ", bookedEconomyClassSeats=" + bookedEconomyClassSeats
				+ ", seatsInFirstClass=" + seatsInFirstClass + ", seatsInBusinessClass=" + seatsInBusinessClass
				+ ", seatsInEconomyClass=" + seatsInEconomyClass + ", flightID=" + flightID + ", flightDate="
				+ flightDate + ", flightTime=" + flightTime + ", destinaition=" + destinaition + ", source=" + source
				+ "]";
	}
