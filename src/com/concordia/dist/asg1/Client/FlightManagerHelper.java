...
public class FlightManagerHelper {
	//private IFlightService flgOpImp = null;
	private BaseServer flgOpImp  =  null;
	//private Object flgOpImp = null;
	...
	private String createManagerAccount(String shortCityName) {
		...
		String filePath = StaticContent.BASE_PATH+"Logs/ManagerIds/" + shortCityName + ".txt";
		int id = 1110;
		String newManagerId = "";
	...
	private void flightManager() {
		try {
			...
			//clogger = new CLogger(LOGGER, "C:/FlightManagerWebService/Logs/Manager/" + managerID + ".log");
	...
	private void setCLoggerForClient() {
		...
		//clogger = new CLogger(LOGGER, "C:/FlightManagerWebService/Logs/Client/client.log");
	}
	...
	private void getFlightDetails(String serverName) {
		...
		try {
			System.out.println("\n**** Home -> Flight Details ****\n");
			flgOpImp = connectToServer(serverName);
			response = flgOpImp.editFlightRecord("-1:" + managerID, Enums.FlightFileds.flightDetail.toString(), "None");
			System.out.println(response);
			clogger.log(response);
	...
	private void getBookingDetails() {
		...
		try {
			...
			// flgOpImp = connectToServer(serverName);
			response = flgOpImp.editFlightRecord("-1:" + managerID, Enums.FlightFileds.bookingDetail.toString(), "None");
			System.out.println(response);
			clogger.log(response);
